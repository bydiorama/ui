...
| `pnpm check:type-roles` | Fail on a declared type-role exception naming a part that no longer exists; the roles themselves are enforced in every story at runtime (ADR 0020 §3) |
